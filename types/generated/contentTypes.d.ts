...
export interface ApiLandingPageLandingPage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    section_one_card: Attribute.Component<
    ...
    section_three_header: Attribute.String;
    reasons_card: Attribute.Component<
      'molecules.repeatable-text-card-icon',
      true
    >;
    section_four_header: Attribute.String;
    testimonial: Attribute.Component<'molecules.testimonial-card', true>;
    section_five_header: Attribute.String;
    staff_cards: Attribute.Component<
